...
public class ParallaxLayer{
    ...
    public int Altura;
    public ParallaxLayer(TextureRegion region,Vector2 parallaxRatio,Vector2 padding,int height){
        this(region, parallaxRatio, new Vector2(0,0),padding,height);
    }
    /**
     ...
     */
    public ParallaxLayer(TextureRegion region,Vector2 parallaxRatio,Vector2 startPosition,Vector2 padding,int height){
        this.region  = region;
